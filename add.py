...
def start(message: telebot.types.Message):
    text = f"Привет, {message.chat.username}! Я - бот, который поможет тебе конвертировать валюты. Напиши мне сообщение в формате: <из какой валюты> <в какую валюту> <сумма для конвертации>.\n Например: доллар рубль 100\n Для того, чтобы увидеть список доступных валют нажмите /values"
